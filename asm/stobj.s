...
/* 8006A6FC 0006661C  4B FD 23 9D */	bl func_8003CA98
...
/* 8006A74C 0006666C  4B FD 78 B5 */	bl func_80042000
lbl_8006A750:
...
/* 8006A814 00066734  4B FD 7F 91 */	bl func_800427A4
...
/* 8006A838 00066758  4B FD 77 C9 */	bl func_80042000
lbl_8006A83C:
...
/* 8006A974 00066894  4B FD 76 8D */	bl func_80042000
lbl_8006A978:
...
/* 8006BD10 00067C30  4B FB 52 C1 */	bl g_frustum_test_maybe_2
...
/* 8006BD98 00067CB8  48 02 2A 15 */	bl g_avdisp_draw_model_1
...
/* 8006BDB0 00067CD0  48 02 29 FD */	bl g_avdisp_draw_model_1
...
/* 8006C2E0 00068200  48 02 21 59 */	bl g_avdisp_maybe_draw_model_1
...
/* 8006C3B4 000682D4  48 02 21 B1 */	bl g_avdisp_set_alpha
lbl_8006C3B8:
...
/* 8006C3C4 000682E4  48 02 21 3D */	bl g_avdisp_maybe_draw_model_3
lbl_8006C3C8:
...
/* 8006C680 000685A0  48 02 1D B9 */	bl g_avdisp_maybe_draw_model_1
...
/* 8006C6B4 000685D4  4B FD 33 41 */	bl func_8003F9F4
...
/* 8006CAC4 000689E4  4B FD 30 85 */	bl func_8003FB48
...
/* 8006E9C8 0006A8E8  48 01 FB 9D */	bl g_avdisp_set_alpha
/* 8006E9CC 0006A8EC  7F E3 FB 78 */	mr r3, r31
/* 8006E9D0 0006A8F0  48 01 FB 31 */	bl g_avdisp_maybe_draw_model_3
...
/* 8006E9F4 0006A914  48 01 FA 45 */	bl g_avdisp_maybe_draw_model_1
...
/* 8006EA78 0006A998  48 01 FA ED */	bl g_avdisp_set_alpha
/* 8006EA7C 0006A99C  7F E3 FB 78 */	mr r3, r31
/* 8006EA80 0006A9A0  48 01 FA 81 */	bl g_avdisp_maybe_draw_model_3
...
/* 8006EAA4 0006A9C4  48 01 F9 95 */	bl g_avdisp_maybe_draw_model_1
lbl_8006EAA8:
...
/* 8006EAE4 0006AA04  48 01 FA 81 */	bl g_avdisp_set_alpha
/* 8006EAE8 0006AA08  7F E3 FB 78 */	mr r3, r31
/* 8006EAEC 0006AA0C  48 01 FA 15 */	bl g_avdisp_maybe_draw_model_3
...
/* 8006EB10 0006AA30  48 01 F9 29 */	bl g_avdisp_maybe_draw_model_1
lbl_8006EB14:
...
/* 8006F20C 0006B12C  4B FD DC FD */	bl func_8004CF08
...
/* 8006F314 0006B234  4B FD DB F5 */	bl func_8004CF08
...
/* 8006FADC 0006B9FC  4B FD D4 2D */	bl func_8004CF08
...
lbl_802F4818:
	# ROM: 0x1EE238
	.byte 0x3D, 0xC2, 0x8F, 0x5C

.global lbl_802F481C
lbl_802F481C:
	# ROM: 0x1EE23C
	.byte 0x3D, 0x67, 0x6C, 0x8B

.global lbl_802F4820
lbl_802F4820:
	# ROM: 0x1EE240
	.byte 0x3B, 0xB9, 0x23, 0xA3

.global lbl_802F4824
lbl_802F4824:
	# ROM: 0x1EE244
	.byte 0x3A, 0x12, 0xCC, 0xF7

.global lbl_802F4828
lbl_802F4828:
	# ROM: 0x1EE248
	.byte 0x3D, 0xD2, 0xF1, 0xAA

.global lbl_802F482C
lbl_802F482C:
	# ROM: 0x1EE24C
	.byte 0x3D, 0xAE, 0x14, 0x7B

.global lbl_802F4830
lbl_802F4830:
	# ROM: 0x1EE250
	.byte 0x3C, 0x0B, 0x43, 0x96

.global lbl_802F4834
lbl_802F4834:
	# ROM: 0x1EE254
	.byte 0x3A, 0x5E, 0xD2, 0x89

.global lbl_802F4838
lbl_802F4838:
	# ROM: 0x1EE258
	.byte 0x3C, 0xE5, 0x60, 0x42

.global lbl_802F483C
lbl_802F483C:
	# ROM: 0x1EE25C
	.byte 0x3B, 0xF5, 0xC2, 0x8F

.global lbl_802F4840
lbl_802F4840:
	# ROM: 0x1EE260
	.byte 0x3A, 0x44, 0x9B, 0xA6
...
lbl_802F48F0:
	# ROM: 0x1EE310
	.byte 0x3F, 0xA8, 0x00, 0x00
	.4byte 0

.global lbl_802F48F8
lbl_802F48F8:
	# ROM: 0x1EE318
	.byte 0x3F, 0x60, 0x62, 0x4D
	.byte 0xD2, 0xF1, 0xA9, 0xFC

.global lbl_802F4900
lbl_802F4900:
	# ROM: 0x1EE320
	.byte 0x3B, 0x03, 0x12, 0x6F
...
lbl_802F4908:
	# ROM: 0x1EE328
	.byte 0x3F, 0xFC, 0x00, 0x00
	.4byte 0

.global lbl_802F4910
lbl_802F4910:
	# ROM: 0x1EE330
	.byte 0x3F, 0xEC, 0x00, 0x00
	.4byte 0
...
lbl_802F4940:
	# ROM: 0x1EE360
	.byte 0x40, 0xE8, 0x00, 0x00
	.4byte 0

.global lbl_802F4948
lbl_802F4948:
	# ROM: 0x1EE368
	.byte 0x40, 0xF8, 0x00, 0x00
	.4byte 0
