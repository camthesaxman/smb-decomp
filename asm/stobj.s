...
/* 8006A65C 0006657C  3C 60 80 20 */	lis r3, g_poolInfo@ha
...
/* 8006A674 00066594  3C C0 80 28 */	lis r6, itemPool@ha
/* 8006A678 00066598  BE 01 00 88 */	stmw r16, 0x88(r1)
/* 8006A67C 0006659C  3A A3 59 88 */	addi r21, r3, g_poolInfo@l
...
/* 8006A6A0 000665C0  3A 06 CE 58 */	addi r16, r6, itemPool@l
...
/* 8006AEEC 00066E0C  3C 60 80 20 */	lis r3, g_poolInfo@ha
/* 8006AEF0 00066E10  38 63 59 88 */	addi r3, r3, g_poolInfo@l
...
/* 8006AF60 00066E80  3C 60 80 20 */	lis r3, g_poolInfo@ha
/* 8006AF64 00066E84  38 83 59 88 */	addi r4, r3, g_poolInfo@l
...
/* 8006B10C 0006702C  3C 60 80 20 */	lis r3, g_poolInfo@ha
/* 8006B110 00067030  90 01 00 04 */	stw r0, 4(r1)
/* 8006B114 00067034  38 83 59 88 */	addi r4, r3, g_poolInfo@l
...
/* 8006B1D8 000670F8  3C 60 80 20 */	lis r3, g_poolInfo@ha
/* 8006B1DC 000670FC  38 83 59 88 */	addi r4, r3, g_poolInfo@l
...
/* 8006B2C4 000671E4  3C 80 80 20 */	lis r4, g_poolInfo@ha
/* 8006B2C8 000671E8  90 01 00 04 */	stw r0, 4(r1)
/* 8006B2CC 000671EC  38 84 59 88 */	addi r4, r4, g_poolInfo@l
...
/* 8006BE44 00067D64  4B FC 4D 75 */	bl nl2ngc_set_material_color
/* 8006BE48 00067D68  80 6D 99 24 */	lwz r3, g_commonNlObj@sda21(r13)
/* 8006BE4C 00067D6C  80 63 00 B0 */	lwz r3, 0xb0(r3)
/* 8006BE50 00067D70  4B FC 55 01 */	bl nl2ngc_draw_model_sort_none
/* 8006BE54 00067D74  4B FA 25 69 */	bl u_reset_post_mult_color
lbl_8006BE58:
...
/* 8006CA50 00068970  80 8D 99 24 */	lwz r4, g_commonNlObj@sda21(r13)
...
/* 8006CCF4 00068C14  80 6D 99 24 */	lwz r3, g_commonNlObj@sda21(r13)
...
/* 8006CD0C 00068C2C  80 6D 99 24 */	lwz r3, g_commonNlObj@sda21(r13)
...
/* 8006CD24 00068C44  80 6D 99 24 */	lwz r3, g_commonNlObj@sda21(r13)
...
/* 8006CD3C 00068C5C  80 6D 99 24 */	lwz r3, g_commonNlObj@sda21(r13)
...
/* 8006CD54 00068C74  80 6D 99 24 */	lwz r3, g_commonNlObj@sda21(r13)
...
/* 8006CD6C 00068C8C  80 6D 99 24 */	lwz r3, g_commonNlObj@sda21(r13)
...
/* 8006CD84 00068CA4  80 6D 99 24 */	lwz r3, g_commonNlObj@sda21(r13)
...
/* 8006CD9C 00068CBC  80 6D 99 24 */	lwz r3, g_commonNlObj@sda21(r13)
...
/* 8006CDB4 00068CD4  80 6D 99 24 */	lwz r3, g_commonNlObj@sda21(r13)
...
/* 8006CDCC 00068CEC  80 6D 99 24 */	lwz r3, g_commonNlObj@sda21(r13)
...
/* 8006CDE4 00068D04  80 6D 99 24 */	lwz r3, g_commonNlObj@sda21(r13)
...
/* 8006CE08 00068D28  80 6D 99 24 */	lwz r3, g_commonNlObj@sda21(r13)
...
/* 8006CE20 00068D40  80 6D 99 24 */	lwz r3, g_commonNlObj@sda21(r13)
...
/* 8006CE38 00068D58  80 6D 99 24 */	lwz r3, g_commonNlObj@sda21(r13)
...
/* 8006CE50 00068D70  80 6D 99 24 */	lwz r3, g_commonNlObj@sda21(r13)
...
/* 8006CE68 00068D88  80 6D 99 24 */	lwz r3, g_commonNlObj@sda21(r13)
...
/* 8006CE80 00068DA0  80 6D 99 24 */	lwz r3, g_commonNlObj@sda21(r13)
...
/* 8006CE98 00068DB8  80 6D 99 24 */	lwz r3, g_commonNlObj@sda21(r13)
...
/* 8006CEB0 00068DD0  80 6D 99 24 */	lwz r3, g_commonNlObj@sda21(r13)
...
/* 8006CEC8 00068DE8  80 6D 99 24 */	lwz r3, g_commonNlObj@sda21(r13)
...
/* 8006D7FC 0006971C  4B FC 33 BD */	bl nl2ngc_set_material_color
/* 8006D800 00069720  3C 80 80 25 */	lis r4, lbl_80250A68@ha
/* 8006D804 00069724  3C 60 80 20 */	lis r3, g_poolInfo@ha
/* 8006D808 00069728  38 84 0A 68 */	addi r4, r4, lbl_80250A68@l
/* 8006D80C 0006972C  38 63 59 88 */	addi r3, r3, g_poolInfo@l
...
/* 8006D900 00069820  4B FC 61 D5 */	bl nl2ngc_draw_model_sort_translucent_alt2
...
/* 8006D93C 0006985C  4B FC 61 99 */	bl nl2ngc_draw_model_sort_translucent_alt2
...
/* 8006D97C 0006989C  4B FC 61 59 */	bl nl2ngc_draw_model_sort_translucent_alt2
...
/* 8006D9B8 000698D8  4B FC 61 1D */	bl nl2ngc_draw_model_sort_translucent_alt2
...
/* 8006D9E8 00069908  4B FC 60 ED */	bl nl2ngc_draw_model_sort_translucent_alt2
/* 8006D9EC 0006990C  4B FA 09 D1 */	bl u_reset_post_mult_color
...
/* 8006F20C 0006B12C  4B FD DC FD */	bl spawn_effect
...
/* 8006F314 0006B234  4B FD DB F5 */	bl spawn_effect
...
/* 8006FADC 0006B9FC  4B FD D4 2D */	bl spawn_effect
