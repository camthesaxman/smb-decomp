...
/* 80041250 0003D170  C8 22 8E 40 */	lfd f1, lbl_802F3640-_SDA2_BASE_(r2)  ;# 1.0
...
/* 800412A4 0003D1C4  EC 00 F0 28 */	fsubs f0, f0, f30  ;# floor(f2)
...
/* 800412D4 0003D1F4  3A A0 00 00 */	li r21, 0  ;# r23 * 4
...
/* 80041324 0003D244  7F 63 DB 78 */	mr r3, r27  ;# Point3d
/* 80041328 0003D248  FC 20 F0 28 */	fsub f1, f0, f30  ;# (float)r24
/* 8004132C 0003D24C  C8 01 09 28 */	lfd f0, 0x928(r1)
/* 80041330 0003D250  38 9B 00 00 */	addi r4, r27, 0  ;# Point3d
/* 80041334 0003D254  38 A0 00 00 */	li r5, 0  ;# NULL
/* 80041338 0003D258  FC 3D 08 2A */	fadd f1, f29, f1
/* 8004133C 0003D25C  FC 00 F0 28 */	fsub f0, f0, f30  ;# (float)r23
/* 80041340 0003D260  FC 20 08 18 */	frsp f1, f1  ;# f29 + r24
...
/* 800413B8 0003D2D8  7C B8 EA 14 */	add r5, r24, r29  ;# r24 + (r23 + 1) * 4
/* 800413BC 0003D2DC  7C 98 F2 14 */	add r4, r24, r30  ;# r24 + (r23 + 1) * 4 + 1
/* 800413C0 0003D2E0  7C 78 FA 14 */	add r3, r24, r31  ;# r24 + r21 + 1
...
/* 800413E0 0003D300  7C A5 32 14 */	add r5, r5, r6   ;# sp20[
