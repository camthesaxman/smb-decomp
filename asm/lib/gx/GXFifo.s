...
/* 800DCF84 000D8EA4  80 AD A3 64 */	lwz r5, __cpReg@sda21(r13)
/* 800DCF88 000D8EA8  80 6D 97 C8 */	lwz r3, gx@sda21(r13)
/* 800DCF8C 000D8EAC  A0 05 00 00 */	lhz r0, 0(r5)
/* 800DCF90 000D8EB0  90 03 00 0C */	stw r0, 0xc(r3)
/* 800DCF94 000D8EB4  80 6D 97 C8 */	lwz r3, gx@sda21(r13)
...
/* 800DCFB0 000D8ED0  80 6D A3 70 */	lwz r3, __GXCurrentThread@sda21(r13)
/* 800DCFB4 000D8ED4  4B FE C3 E1 */	bl OSResumeThread
/* 800DCFB8 000D8ED8  38 00 00 00 */	li r0, 0
/* 800DCFBC 000D8EDC  90 0D A3 78 */	stw r0, GXOverflowSuspendInProgress@sda21(r13)
...
lbl_800DCFD8:
/* 800DCFD8 000D8EF8  80 6D 97 C8 */	lwz r3, gx@sda21(r13)
...
/* 800DCFF4 000D8F14  80 AD A3 80 */	lwz r5, __GXOverflowCount@sda21(r13)
/* 800DCFF8 000D8F18  38 60 00 00 */	li r3, 0
/* 800DCFFC 000D8F1C  38 80 00 01 */	li r4, 1
/* 800DD000 000D8F20  38 05 00 01 */	addi r0, r5, 1
/* 800DD004 000D8F24  90 0D A3 80 */	stw r0, __GXOverflowCount@sda21(r13)
...
/* 800DD01C 000D8F3C  80 6D A3 70 */	lwz r3, __GXCurrentThread@sda21(r13)
/* 800DD020 000D8F40  90 0D A3 78 */	stw r0, GXOverflowSuspendInProgress@sda21(r13)
/* 800DD024 000D8F44  4B FE C5 F9 */	bl OSSuspendThread
lbl_800DD028:
/* 800DD028 000D8F48  80 6D 97 C8 */	lwz r3, gx@sda21(r13)
...
/* 800DD050 000D8F70  80 8D 97 C8 */	lwz r4, gx@sda21(r13)
/* 800DD054 000D8F74  80 6D A3 64 */	lwz r3, __cpReg@sda21(r13)
/* 800DD058 000D8F78  80 04 00 08 */	lwz r0, 8(r4)
/* 800DD05C 000D8F7C  B0 03 00 02 */	sth r0, 2(r3)
/* 800DD060 000D8F80  80 0D A3 7C */	lwz r0, BreakPointCB@sda21(r13)
...
/* 800DD07C 000D8F9C  81 8D A3 7C */	lwz r12, BreakPointCB@sda21(r13)
...
/* 800DD1B0 000D90D0  80 0D A3 84 */	lwz r0, GPFifo@sda21(r13)
/* 800DD1B4 000D90D4  3B E3 00 00 */	addi r31, r3, 0
/* 800DD1B8 000D90D8  93 CD A3 88 */	stw r30, CPUFifo@sda21(r13)
...
/* 800DD1CC 000D90EC  80 8D A3 60 */	lwz r4, __piReg@sda21(r13)
...
/* 800DD1E4 000D9104  80 AD A3 60 */	lwz r5, __piReg@sda21(r13)
...
/* 800DD1F4 000D9114  80 AD A3 60 */	lwz r5, __piReg@sda21(r13)
...
/* 800DD204 000D9124  98 0D A3 74 */	stb r0, CPGPLinked@sda21(r13)
...
lbl_800DD224:
/* 800DD224 000D9144  88 0D A3 74 */	lbz r0, CPGPLinked@sda21(r13)
...
/* 800DD23C 000D915C  98 0D A3 74 */	stb r0, CPGPLinked@sda21(r13)
lbl_800DD240:
...
/* 800DD250 000D9170  80 6D A3 60 */	lwz r3, __piReg@sda21(r13)
...
/* 800DD260 000D9180  80 6D A3 60 */	lwz r3, __piReg@sda21(r13)
...
/* 800DD270 000D9190  80 6D A3 60 */	lwz r3, __piReg@sda21(r13)
...
/* 800DD2D4 000D91F4  93 CD A3 84 */	stw r30, GPFifo@sda21(r13)
/* 800DD2D8 000D91F8  80 6D A3 64 */	lwz r3, __cpReg@sda21(r13)
...
/* 800DD340 000D9260  80 6D A3 64 */	lwz r3, __cpReg@sda21(r13)
...
/* 800DD350 000D9270  80 6D A3 64 */	lwz r3, __cpReg@sda21(r13)
...
/* 800DD360 000D9280  80 6D A3 64 */	lwz r3, __cpReg@sda21(r13)
...
/* 800DD370 000D9290  80 6D A3 64 */	lwz r3, __cpReg@sda21(r13)
...
/* 800DD380 000D92A0  80 6D A3 64 */	lwz r3, __cpReg@sda21(r13)
...
/* 800DD390 000D92B0  80 6D A3 64 */	lwz r3, __cpReg@sda21(r13)
...
/* 800DD3A0 000D92C0  80 6D A3 88 */	lwz r3, CPUFifo@sda21(r13)
/* 800DD3A4 000D92C4  80 0D A3 84 */	lwz r0, GPFifo@sda21(r13)
...
/* 800DD3B4 000D92D4  98 0D A3 74 */	stb r0, CPGPLinked@sda21(r13)
...
/* 800DD3D4 000D92F4  98 0D A3 74 */	stb r0, CPGPLinked@sda21(r13)
...
/* 800DD460 000D9380  80 6D A3 60 */	lwz r3, __piReg@sda21(r13)
...
/* 800DD470 000D9390  80 6D A3 60 */	lwz r3, __piReg@sda21(r13)
...
/* 800DD480 000D93A0  80 6D A3 60 */	lwz r3, __piReg@sda21(r13)
...
/* 800DD494 000D93B4  88 0D A3 74 */	lbz r0, CPGPLinked@sda21(r13)
/* 800DD498 000D93B8  28 00 00 00 */	cmplwi r0, 0
/* 800DD49C 000D93BC  41 82 00 34 */	beq lbl_800DD4D0
/* 800DD4A0 000D93C0  80 8D A3 64 */	lwz r4, __cpReg@sda21(r13)
...
/* 800DD4B8 000D93D8  80 8D A3 64 */	lwz r4, __cpReg@sda21(r13)
...
GXGetGPStatus:
/* 800DD518 000D9438  81 2D A3 64 */	lwz r9, __cpReg@sda21(r13)
/* 800DD51C 000D943C  81 0D 97 C8 */	lwz r8, gx@sda21(r13)
/* 800DD520 000D9440  A0 09 00 00 */	lhz r0, 0(r9)
/* 800DD524 000D9444  90 08 00 0C */	stw r0, 0xc(r8)
/* 800DD528 000D9448  81 0D 97 C8 */	lwz r8, gx@sda21(r13)
...
/* 800DD538 000D9458  80 6D 97 C8 */	lwz r3, gx@sda21(r13)
...
/* 800DD548 000D9468  80 6D 97 C8 */	lwz r3, gx@sda21(r13)
...
/* 800DD558 000D9478  80 6D 97 C8 */	lwz r3, gx@sda21(r13)
...
/* 800DD568 000D9488  80 6D 97 C8 */	lwz r3, gx@sda21(r13)
...
GXGetFifoPtrs:
/* 800DD57C 000D949C  80 0D A3 88 */	lwz r0, CPUFifo@sda21(r13)
/* 800DD580 000D94A0  7C 03 00 40 */	cmplw r3, r0
/* 800DD584 000D94A4  40 82 00 18 */	bne lbl_800DD59C
/* 800DD588 000D94A8  80 CD A3 60 */	lwz r6, __piReg@sda21(r13)
...
lbl_800DD59C:
/* 800DD59C 000D94BC  80 0D A3 84 */	lwz r0, GPFifo@sda21(r13)
/* 800DD5A0 000D94C0  7C 03 00 40 */	cmplw r3, r0
/* 800DD5A4 000D94C4  40 82 00 34 */	bne lbl_800DD5D8
/* 800DD5A8 000D94C8  80 ED A3 64 */	lwz r7, __cpReg@sda21(r13)
...
/* 800DD5C0 000D94E0  80 ED A3 64 */	lwz r7, __cpReg@sda21(r13)
...
/* 800DD640 000D9560  90 6D A3 70 */	stw r3, __GXCurrentThread@sda21(r13)
/* 800DD644 000D9564  90 0D A3 78 */	stw r0, GXOverflowSuspendInProgress@sda21(r13)
...
__GXFifoReadEnable:
/* 800DD658 000D9578  80 6D 97 C8 */	lwz r3, gx@sda21(r13)
...
/* 800DD66C 000D958C  80 8D 97 C8 */	lwz r4, gx@sda21(r13)
/* 800DD670 000D9590  80 6D A3 64 */	lwz r3, __cpReg@sda21(r13)
...
__GXFifoReadDisable:
/* 800DD680 000D95A0  80 6D 97 C8 */	lwz r3, gx@sda21(r13)
...
/* 800DD690 000D95B0  80 8D 97 C8 */	lwz r4, gx@sda21(r13)
/* 800DD694 000D95B4  80 6D A3 64 */	lwz r3, __cpReg@sda21(r13)
...
lbl_800DD6B8:
/* 800DD6B8 000D95D8  80 6D 97 C8 */	lwz r3, gx@sda21(r13)
...
/* 800DD6D4 000D95F4  80 8D 97 C8 */	lwz r4, gx@sda21(r13)
/* 800DD6D8 000D95F8  80 6D A3 64 */	lwz r3, __cpReg@sda21(r13)
...
/* 800DD6E8 000D9608  80 AD 97 C8 */	lwz r5, gx@sda21(r13)
...
/* 800DD708 000D9628  80 6D 97 C8 */	lwz r3, gx@sda21(r13)
...
/* 800DD720 000D9640  80 8D 97 C8 */	lwz r4, gx@sda21(r13)
/* 800DD724 000D9644  80 6D A3 64 */	lwz r3, __cpReg@sda21(r13)
...
/* 800DD734 000D9654  80 AD 97 C8 */	lwz r5, gx@sda21(r13)
...
/* 800DD754 000D9674  80 6D 97 C8 */	lwz r3, gx@sda21(r13)
...
/* 800DD76C 000D968C  80 8D 97 C8 */	lwz r4, gx@sda21(r13)
/* 800DD770 000D9690  80 6D A3 64 */	lwz r3, __cpReg@sda21(r13)
...
.global GXGetCPUFifo
GXGetCPUFifo:
/* 800DD780 000D96A0  80 6D A3 88 */	lwz r3, CPUFifo@sda21(r13)
