...
/* 800DF678 000DB598  80 6D 97 C8 */	lwz r3, gx@sda21(r13)
...
lbl_800DF68C:
/* 800DF68C 000DB5AC  80 6D 97 C8 */	lwz r3, gx@sda21(r13)
...
lbl_800DF6A0:
/* 800DF6A0 000DB5C0  80 6D 97 C8 */	lwz r3, gx@sda21(r13)
...
lbl_800DF6B4:
/* 800DF6B4 000DB5D4  80 6D 97 C8 */	lwz r3, gx@sda21(r13)
...
lbl_800DF6C8:
/* 800DF6C8 000DB5E8  80 6D 97 C8 */	lwz r3, gx@sda21(r13)
...
lbl_800DF6DC:
/* 800DF6DC 000DB5FC  80 6D 97 C8 */	lwz r3, gx@sda21(r13)
...
/* 800DF71C 000DB63C  80 CD 97 C8 */	lwz r6, gx@sda21(r13)
...
lbl_800DF738:
/* 800DF738 000DB658  80 6D 97 C8 */	lwz r3, gx@sda21(r13)
...
lbl_800DF74C:
/* 800DF74C 000DB66C  80 6D 97 C8 */	lwz r3, gx@sda21(r13)
...
lbl_800DF760:
/* 800DF760 000DB680  80 6D 97 C8 */	lwz r3, gx@sda21(r13)
...
lbl_800DF774:
/* 800DF774 000DB694  80 6D 97 C8 */	lwz r3, gx@sda21(r13)
...
lbl_800DF788:
/* 800DF788 000DB6A8  80 6D 97 C8 */	lwz r3, gx@sda21(r13)
/* 800DF78C 000DB6AC  38 00 00 00 */	li r0, 0
/* 800DF790 000DB6B0  90 03 04 F0 */	stw r0, 0x4f0(r3)
lbl_800DF794:
/* 800DF794 000DB6B4  80 6D 97 C8 */	lwz r3, gx@sda21(r13)
...
__GXSendFlushPrim:
/* 800DF7D4 000DB6F4  80 6D 97 C8 */	lwz r3, gx@sda21(r13)
...
lbl_800DF84C:
/* 800DF84C 000DB76C  80 6D 97 C8 */	lwz r3, gx@sda21(r13)
...
GXSetLineWidth:
/* 800DF85C 000DB77C  80 AD 97 C8 */	lwz r5, gx@sda21(r13)
...
/* 800DF884 000DB7A4  80 6D 97 C8 */	lwz r3, gx@sda21(r13)
...
/* 800DF8A0 000DB7C0  80 8D 97 C8 */	lwz r4, gx@sda21(r13)
...
GXSetPointSize:
/* 800DF8B4 000DB7D4  80 AD 97 C8 */	lwz r5, gx@sda21(r13)
...
/* 800DF8D8 000DB7F8  80 6D 97 C8 */	lwz r3, gx@sda21(r13)
...
/* 800DF8F4 000DB814  80 8D 97 C8 */	lwz r4, gx@sda21(r13)
...
GXEnableTexOffsets:
/* 800DF908 000DB828  80 0D 97 C8 */	lwz r0, gx@sda21(r13)
...
/* 800DF934 000DB854  80 CD 97 C8 */	lwz r6, gx@sda21(r13)
...
/* 800DF950 000DB870  80 8D 97 C8 */	lwz r4, gx@sda21(r13)
...
lbl_800DF990:
/* 800DF990 000DB8B0  80 8D 97 C8 */	lwz r4, gx@sda21(r13)
...
/* 800DF9A8 000DB8C8  80 6D 97 C8 */	lwz r3, gx@sda21(r13)
...
GXSetCoPlanar:
/* 800DF9BC 000DB8DC  80 8D 97 C8 */	lwz r4, gx@sda21(r13)
...
/* 800DF9E8 000DB908  80 6D 97 C8 */	lwz r3, gx@sda21(r13)
...
/* 800DFA04 000DB924  80 8D 97 C8 */	lwz r4, gx@sda21(r13)
