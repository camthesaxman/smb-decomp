...
/* 800D28FC 000CE81C  83 ED A2 BC */	lwz r31, __AID_Callback-_SDA_BASE_(r13)
/* 800D2900 000CE820  4B FF 37 BD */	bl OSDisableInterrupts
/* 800D2904 000CE824  93 CD A2 BC */	stw r30, __AID_Callback-_SDA_BASE_(r13)
...
/* 800D29E0 000CE900  83 ED A2 B8 */	lwz r31, __AIS_Callback-_SDA_BASE_(r13)
/* 800D29E4 000CE904  4B FF 36 D9 */	bl OSDisableInterrupts
/* 800D29E8 000CE908  93 CD A2 B8 */	stw r30, __AIS_Callback-_SDA_BASE_(r13)
...
/* 800D2D98 000CECB8  80 0D A2 C8 */	lwz r0, __AI_init_flag-_SDA_BASE_(r13)
...
/* 800D2E08 000CED28  91 0D A2 D4 */	stw r8, lbl_802F24B4-_SDA_BASE_(r13)
/* 800D2E0C 000CED2C  54 A5 BA 7E */	srwi r5, r5, 9
/* 800D2E10 000CED30  54 84 BA 7E */	srwi r4, r4, 9
/* 800D2E14 000CED34  90 ED A2 DC */	stw r7, lbl_802F24BC-_SDA_BASE_(r13)
/* 800D2E18 000CED38  3B E0 00 00 */	li r31, 0
/* 800D2E1C 000CED3C  54 63 BA 7E */	srwi r3, r3, 9
/* 800D2E20 000CED40  90 AD A2 E4 */	stw r5, lbl_802F24C4-_SDA_BASE_(r13)
/* 800D2E24 000CED44  3C C0 CC 00 */	lis r6, 0xCC006C00@ha
/* 800D2E28 000CED48  90 6D A2 F4 */	stw r3, lbl_802F24D4-_SDA_BASE_(r13)
/* 800D2E2C 000CED4C  38 60 00 01 */	li r3, 1
/* 800D2E30 000CED50  80 06 6C 00 */	lwz r0, 0xCC006C00@l(r6)
/* 800D2E34 000CED54  90 8D A2 EC */	stw r4, lbl_802F24CC-_SDA_BASE_(r13)
/* 800D2E38 000CED58  54 00 06 F2 */	rlwinm r0, r0, 0, 0x1b, 0x19
/* 800D2E3C 000CED5C  60 00 00 20 */	ori r0, r0, 0x20
/* 800D2E40 000CED60  93 ED A2 D0 */	stw r31, bound_32KHz-_SDA_BASE_(r13)
/* 800D2E44 000CED64  93 ED A2 D8 */	stw r31, bound_48KHz-_SDA_BASE_(r13)
/* 800D2E48 000CED68  93 ED A2 E0 */	stw r31, min_wait-_SDA_BASE_(r13)
/* 800D2E4C 000CED6C  93 ED A2 E8 */	stw r31, max_wait-_SDA_BASE_(r13)
/* 800D2E50 000CED70  93 ED A2 F0 */	stw r31, buffer-_SDA_BASE_(r13)
...
/* 800D2E8C 000CEDAC  93 ED A2 B8 */	stw r31, __AIS_Callback-_SDA_BASE_(r13)
/* 800D2E90 000CEDB0  38 83 2F 60 */	addi r4, r3, __AIDHandler@l
/* 800D2E94 000CEDB4  93 ED A2 BC */	stw r31, __AID_Callback-_SDA_BASE_(r13)
/* 800D2E98 000CEDB8  38 60 00 05 */	li r3, 5
/* 800D2E9C 000CEDBC  93 CD A2 C0 */	stw r30, __CallbackStack-_SDA_BASE_(r13)
...
/* 800D2EC8 000CEDE8  90 0D A2 C8 */	stw r0, __AI_init_flag-_SDA_BASE_(r13)
lbl_800D2ECC:
...
/* 800D2F1C 000CEE3C  81 8D A2 B8 */	lwz r12, __AIS_Callback-_SDA_BASE_(r13)
...
/* 800D2FA0 000CEEC0  80 6D A2 BC */	lwz r3, __AID_Callback-_SDA_BASE_(r13)
/* 800D2FA4 000CEEC4  28 03 00 00 */	cmplwi r3, 0
/* 800D2FA8 000CEEC8  41 82 00 24 */	beq lbl_800D2FCC
/* 800D2FAC 000CEECC  80 0D A2 C0 */	lwz r0, __CallbackStack-_SDA_BASE_(r13)
...
/* 800D3114 000CF034  81 8D A2 D4 */	lwz r12, lbl_802F24B4-_SDA_BASE_(r13)
/* 800D3118 000CF038  80 BF 6C 00 */	lwz r5, 0x6c00(r31)
/* 800D311C 000CF03C  7C FB 19 10 */	subfe r7, r27, r3
/* 800D3120 000CF040  81 4D A2 F4 */	lwz r10, lbl_802F24D4-_SDA_BASE_(r13)
/* 800D3124 000CF044  6C E7 80 00 */	xoris r7, r7, 0x8000
/* 800D3128 000CF048  54 A5 07 FA */	rlwinm r5, r5, 0, 0x1f, 0x1d
/* 800D312C 000CF04C  81 6D A2 D0 */	lwz r11, bound_32KHz-_SDA_BASE_(r13)
/* 800D3130 000CF050  7C CA 60 10 */	subfc r6, r10, r12
/* 800D3134 000CF054  81 2D A2 F0 */	lwz r9, buffer-_SDA_BASE_(r13)
...
/* 800D3168 000CF088  83 AD A2 E0 */	lwz r29, min_wait-_SDA_BASE_(r13)
/* 800D316C 000CF08C  38 00 00 01 */	li r0, 1
/* 800D3170 000CF090  83 8D A2 E4 */	lwz r28, lbl_802F24C4-_SDA_BASE_(r13)
...
/* 800D319C 000CF0BC  80 AD A2 DC */	lwz r5, lbl_802F24BC-_SDA_BASE_(r13)
/* 800D31A0 000CF0C0  80 0D A2 D8 */	lwz r0, bound_48KHz-_SDA_BASE_(r13)
...
/* 800D31C8 000CF0E8  83 AD A2 E8 */	lwz r29, max_wait-_SDA_BASE_(r13)
/* 800D31CC 000CF0EC  38 00 00 01 */	li r0, 1
/* 800D31D0 000CF0F0  83 8D A2 EC */	lwz r28, lbl_802F24CC-_SDA_BASE_(r13)
