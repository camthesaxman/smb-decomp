...
/* 800CEBE0 000CAB00  80 0D A2 38 */	lwz r0, status-_SDA_BASE_(r13)
...
/* 800CEC00 000CAB20  80 8D A2 3C */	lwz r4, bb2-_SDA_BASE_(r13)
/* 800CEC04 000CAB24  3C 60 80 0D */	lis r3, cb@ha
/* 800CEC08 000CAB28  90 0D A2 38 */	stw r0, status-_SDA_BASE_(r13)
...
/* 800CEC28 000CAB48  80 CD A2 3C */	lwz r6, bb2-_SDA_BASE_(r13)
/* 800CEC2C 000CAB4C  90 0D A2 38 */	stw r0, status-_SDA_BASE_(r13)
...
/* 800CEC6C 000CAB8C  90 0D A2 38 */	stw r0, status-_SDA_BASE_(r13)
/* 800CEC70 000CAB90  4B FF F5 CD */	bl DVDReset
/* 800CEC74 000CAB94  3C 60 80 0D */	lis r3, cb@ha
/* 800CEC78 000CAB98  80 8D A2 40 */	lwz r4, idTmp-_SDA_BASE_(r13)
...
/* 800CECD8 000CABF8  90 6D A2 40 */	stw r3, idTmp-_SDA_BASE_(r13)
/* 800CECDC 000CABFC  90 0D A2 3C */	stw r0, bb2-_SDA_BASE_(r13)
/* 800CECE0 000CAC00  4B FF F5 5D */	bl DVDReset
/* 800CECE4 000CAC04  3C 60 80 2C */	lis r3, block@ha
/* 800CECE8 000CAC08  80 8D A2 40 */	lwz r4, idTmp-_SDA_BASE_(r13)
...
/* 800CED08 000CAC28  80 6D A2 3C */	lwz r3, bb2-_SDA_BASE_(r13)
...
/* 800CED24 000CAC44  80 8D A2 3C */	lwz r4, bb2-_SDA_BASE_(r13)
/* 800CED28 000CAC48  80 04 00 0C */	lwz r0, 0xc(r4)
/* 800CED2C 000CAC4C  90 1E 00 3C */	stw r0, 0x3c(r30)
/* 800CED30 000CAC50  80 8D A2 40 */	lwz r4, idTmp-_SDA_BASE_(r13)
/* 800CED34 000CAC54  4B F3 46 E1 */	bl memcpy
/* 800CED38 000CAC58  38 6D 97 88 */	addi r3, r13, lbl_802F1968-_SDA_BASE_
...
/* 800CEDA0 000CACC0  38 8D 97 8C */	addi r4, r13, lbl_802F196C-_SDA_BASE_
/* 800CEDA4 000CACC4  48 00 00 08 */	b lbl_800CEDAC
lbl_800CEDA8:
/* 800CEDA8 000CACC8  38 8D 97 90 */	addi r4, r13, lbl_802F1970-_SDA_BASE_
lbl_800CEDAC:
...
/* 800CEDB8 000CACD8  38 6D 97 88 */	addi r3, r13, lbl_802F1968-_SDA_BASE_
/* 800CEDBC 000CACDC  4C C6 31 82 */	crclr 6
/* 800CEDC0 000CACE0  4B FF 4E 61 */	bl OSReport
/* 800CEDC4 000CACE4  80 6D A2 3C */	lwz r3, bb2-_SDA_BASE_(r13)
