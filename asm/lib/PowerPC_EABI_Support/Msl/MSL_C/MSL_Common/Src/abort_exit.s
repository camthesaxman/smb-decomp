...
/* 80103C58 000FFB78  80 0D A5 D0 */	lwz r0, __aborting-_SDA_BASE_(r13)
...
lbl_80103C70:
/* 80103C70 000FFB90  80 6D A5 D4 */	lwz r3, atexit_curr_func-_SDA_BASE_(r13)
/* 80103C74 000FFB94  38 63 FF FF */	addi r3, r3, -1
/* 80103C78 000FFB98  54 60 10 3A */	slwi r0, r3, 2
/* 80103C7C 000FFB9C  90 6D A5 D4 */	stw r3, atexit_curr_func-_SDA_BASE_(r13)
...
lbl_80103C90:
/* 80103C90 000FFBB0  80 0D A5 D4 */	lwz r0, atexit_curr_func-_SDA_BASE_(r13)
...
/* 80103CC8 000FFBE8  81 8D A5 DC */	lwz r12, __stdio_exit-_SDA_BASE_(r13)
...
/* 80103CE0 000FFC00  90 0D A5 DC */	stw r0, __stdio_exit-_SDA_BASE_(r13)
lbl_80103CE4:
...
lbl_80103CF0:
/* 80103CF0 000FFC10  80 6D A5 D8 */	lwz r3, __atexit_curr_func-_SDA_BASE_(r13)
/* 80103CF4 000FFC14  38 63 FF FF */	addi r3, r3, -1
/* 80103CF8 000FFC18  54 60 10 3A */	slwi r0, r3, 2
/* 80103CFC 000FFC1C  90 6D A5 D8 */	stw r3, __atexit_curr_func-_SDA_BASE_(r13)
...
lbl_80103D10:
/* 80103D10 000FFC30  80 0D A5 D8 */	lwz r0, __atexit_curr_func-_SDA_BASE_(r13)
...
/* 80103D20 000FFC40  81 8D A5 E0 */	lwz r12, __console_exit-_SDA_BASE_(r13)
...
/* 80103D38 000FFC58  90 0D A5 E0 */	stw r0, __console_exit-_SDA_BASE_(r13)
lbl_80103D3C:
