...
OSGetConsoleType:
/* 800C17AC 000BD6CC  80 6D A0 F0 */	lwz r3, BootInfo-_SDA_BASE_(r13)
...
/* 800C17E8 000BD708  80 0D A0 F8 */	lwz r0, AreWeInitialized-_SDA_BASE_(r13)
...
/* 800C1800 000BD720  90 0D A0 F8 */	stw r0, AreWeInitialized-_SDA_BASE_(r13)
...
/* 800C1810 000BD730  90 0D A0 F4 */	stw r0, BI2DebugFlag-_SDA_BASE_(r13)
/* 800C1814 000BD734  90 6D A0 F0 */	stw r3, BootInfo-_SDA_BASE_(r13)
/* 800C1818 000BD738  90 0D A1 E4 */	stw r0, __DVDLongFileNameFlag-_SDA_BASE_(r13)
...
/* 800C182C 000BD74C  90 0D A0 F4 */	stw r0, BI2DebugFlag-_SDA_BASE_(r13)
/* 800C1830 000BD750  80 03 00 20 */	lwz r0, 0x20(r3)
/* 800C1834 000BD754  90 0D A1 E4 */	stw r0, __DVDLongFileNameFlag-_SDA_BASE_(r13)
/* 800C1838 000BD758  80 03 00 24 */	lwz r0, 0x24(r3)
/* 800C183C 000BD75C  90 0D A2 AC */	stw r0, __PADSpec-_SDA_BASE_(r13)
lbl_800C1840:
...
/* 800C1860 000BD780  80 6D A0 F0 */	lwz r3, BootInfo-_SDA_BASE_(r13)
...
/* 800C1870 000BD790  80 6D A0 F4 */	lwz r3, BI2DebugFlag-_SDA_BASE_(r13)
...
lbl_800C189C:
/* 800C189C 000BD7BC  80 6D A0 F0 */	lwz r3, BootInfo-_SDA_BASE_(r13)
...
/* 800C18F8 000BD818  80 6D A0 F0 */	lwz r3, BootInfo-_SDA_BASE_(r13)
...
/* 800C192C 000BD84C  80 AD A0 F0 */	lwz r5, BootInfo-_SDA_BASE_(r13)
...
/* 800C1978 000BD898  80 6D A0 F0 */	lwz r3, BootInfo-_SDA_BASE_(r13)
...
lbl_800C1A40:
/* 800C1A40 000BD960  80 8D A0 F0 */	lwz r4, BootInfo-_SDA_BASE_(r13)
...
/* 800C1A78 000BD998  80 6D A0 F4 */	lwz r3, BI2DebugFlag-_SDA_BASE_(r13)
...
lbl_800C1B7C:
/* 800C1B7C 000BDA9C  80 6D A0 F4 */	lwz r3, BI2DebugFlag-_SDA_BASE_(r13)
...
/* 800C1CD4 000BDBF4  90 0D A0 FC */	stw r0, OSExceptionTable-_SDA_BASE_(r13)
...
/* 800C1D5C 000BDC7C  80 6D A0 FC */	lwz r3, OSExceptionTable-_SDA_BASE_(r13)
