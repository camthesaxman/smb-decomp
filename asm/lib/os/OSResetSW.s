...
/* 800C75A8 000C34C8  90 8D A1 64 */	stw r4, lbl_802F2344-_SDA_BASE_(r13)
...
/* 800C75B8 000C34D8  90 6D A1 60 */	stw r3, HoldDown-_SDA_BASE_(r13)
...
/* 800C75DC 000C34FC  80 CD A1 64 */	lwz r6, lbl_802F2344-_SDA_BASE_(r13)
/* 800C75E0 000C3500  6F C5 80 00 */	xoris r5, r30, 0x8000
/* 800C75E4 000C3504  80 0D A1 60 */	lwz r0, HoldDown-_SDA_BASE_(r13)
...
/* 800C7628 000C3548  90 0D A1 4C */	stw r0, Down-_SDA_BASE_(r13)
/* 800C762C 000C354C  38 60 02 00 */	li r3, 0x200
/* 800C7630 000C3550  90 0D A1 50 */	stw r0, LastState-_SDA_BASE_(r13)
/* 800C7634 000C3554  4B FF EE 29 */	bl __OSMaskInterrupts
/* 800C7638 000C3558  81 8D A1 48 */	lwz r12, ResetCallback-_SDA_BASE_(r13)
...
/* 800C764C 000C356C  90 0D A1 48 */	stw r0, ResetCallback-_SDA_BASE_(r13)
...
/* 800C76AC 000C35CC  80 0D A1 4C */	lwz r0, Down-_SDA_BASE_(r13)
/* 800C76B0 000C35D0  2C 00 00 00 */	cmpwi r0, 0
/* 800C76B4 000C35D4  40 82 00 44 */	bne lbl_800C76F8
/* 800C76B8 000C35D8  80 0D A1 58 */	lwz r0, HoldUp-_SDA_BASE_(r13)
/* 800C76BC 000C35DC  38 80 00 00 */	li r4, 0
/* 800C76C0 000C35E0  80 6D A1 5C */	lwz r3, lbl_802F233C-_SDA_BASE_(r13)
...
/* 800C76D0 000C35F0  90 AD A1 4C */	stw r5, Down-_SDA_BASE_(r13)
...
/* 800C76EC 000C360C  90 8D A1 64 */	stw r4, lbl_802F2344-_SDA_BASE_(r13)
/* 800C76F0 000C3610  90 6D A1 60 */	stw r3, HoldDown-_SDA_BASE_(r13)
/* 800C76F4 000C3614  48 00 01 50 */	b lbl_800C7844
lbl_800C76F8:
/* 800C76F8 000C3618  80 0D A1 58 */	lwz r0, HoldUp-_SDA_BASE_(r13)
/* 800C76FC 000C361C  3B E0 00 00 */	li r31, 0
/* 800C7700 000C3620  80 6D A1 5C */	lwz r3, lbl_802F233C-_SDA_BASE_(r13)
...
/* 800C7720 000C3640  80 ED A1 64 */	lwz r7, lbl_802F2344-_SDA_BASE_(r13)
...
/* 800C7730 000C3650  80 CD A1 60 */	lwz r6, HoldDown-_SDA_BASE_(r13)
...
lbl_800C778C:
/* 800C778C 000C36AC  80 0D A1 4C */	lwz r0, Down-_SDA_BASE_(r13)
/* 800C7790 000C36B0  2C 00 00 00 */	cmpwi r0, 0
/* 800C7794 000C36B4  41 82 00 2C */	beq lbl_800C77C0
/* 800C7798 000C36B8  80 6D A1 50 */	lwz r3, LastState-_SDA_BASE_(r13)
/* 800C779C 000C36BC  38 00 00 00 */	li r0, 0
/* 800C77A0 000C36C0  90 0D A1 4C */	stw r0, Down-_SDA_BASE_(r13)
...
/* 800C77B4 000C36D4  90 8D A1 5C */	stw r4, lbl_802F233C-_SDA_BASE_(r13)
/* 800C77B8 000C36D8  90 6D A1 58 */	stw r3, HoldUp-_SDA_BASE_(r13)
/* 800C77BC 000C36DC  48 00 00 88 */	b lbl_800C7844
lbl_800C77C0:
/* 800C77C0 000C36E0  80 0D A1 58 */	lwz r0, HoldUp-_SDA_BASE_(r13)
/* 800C77C4 000C36E4  3B C0 00 00 */	li r30, 0
/* 800C77C8 000C36E8  80 6D A1 5C */	lwz r3, lbl_802F233C-_SDA_BASE_(r13)
...
/* 800C77E4 000C3704  80 ED A1 5C */	lwz r7, lbl_802F233C-_SDA_BASE_(r13)
...
/* 800C77F4 000C3714  80 CD A1 58 */	lwz r6, HoldUp-_SDA_BASE_(r13)
...
/* 800C7838 000C3758  90 0D A1 5C */	stw r0, lbl_802F233C-_SDA_BASE_(r13)
/* 800C783C 000C375C  3B C0 00 00 */	li r30, 0
/* 800C7840 000C3760  90 0D A1 58 */	stw r0, HoldUp-_SDA_BASE_(r13)
lbl_800C7844:
/* 800C7844 000C3764  93 CD A1 50 */	stw r30, LastState-_SDA_BASE_(r13)
