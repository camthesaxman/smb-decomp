...
/* 8002151C 0001D43C  EC 82 18 24 */	fdivs f4, f2, f3  ;# 1.0f / f3
...
/* 8002152C 0001D44C  EC 01 00 24 */	fdivs f0, f1, f0  ;# 0.95f / (0.05 * f3)
/* 80021530 0001D450  EC 25 01 32 */	fmuls f1, f5, f4  ;# -85f * (1.0f / f3)
...
/* 80021558 0001D478  EC 01 00 32 */	fmuls f0, f1, f0  ;# 0.05 * (f3 * f3)
/* 8002155C 0001D47C  C0 5F 00 44 */	lfs f2, 0x44(r31)
/* 80021560 0001D480  C0 3F 00 3C */	lfs f1, 0x3c(r31)
/* 80021564 0001D484  EC 84 10 2A */	fadds f4, f4, f2  ;# c->unk44 + -0.1
...
/* 80021590 0001D4B0  EC 01 00 32 */	fmuls f0, f1, f0  ;# 0.05 * (f3 * f3)
...
/* 800215A0 0001D4C0  EC 63 08 2A */	fadds f3, f3, f1  ;# -0.1 + unk44
/* 800215A4 0001D4C4  EC 02 00 24 */	fdivs f0, f2, f0  ;# 0.95 / (0.05 * (f3 * f3))
...
/* 80021798 0001D6B8  3B DF 09 C0 */	addi r30, r31, 0x9c0  ;# unk34
...
/* 80021A04 0001D924  38 FF 00 0C */	addi r7, r31, 0xc  ;# lbl_801EFC94
/* 80021A08 0001D928  38 9F 09 D4 */	addi r4, r31, 0x9d4  ;# lbl_801F065C
...
/* 80021A54 0001D974  41 82 00 E8 */	beq lbl_80021B3C  ;# break
lbl_80021A58:
...
/* 80021B4C 0001DA6C  B0 1F 0C 2C */	sth r0, 0xc2c(r31)  ;# 801F08B4
lbl_80021B50:
...
/* 80021B68 0001DA88  3B DE 09 D4 */	addi r30, r30, 0x9d4  ;# lbl_801F065C
lbl_80021B6C:
...
/* 80021BB8 0001DAD8  80 7C 00 00 */	lwz r3, 0(r28)  ;# lbl_801F0614.unk44
...
/* 80021BD0 0001DAF0  3B D9 00 00 */	addi r30, r25, 0  ;# offset 2
/* 80021BD4 0001DAF4  3B BB 00 00 */	addi r29, r27, 0  ;# offset 2
lbl_80021BD8:
