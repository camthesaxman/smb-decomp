...
/* 800E41CC 000E00EC  80 8D 97 C8 */	lwz r4, gx@sda21(r13)
...
lbl_800E41E4:
/* 800E41E4 000E0104  80 8D 97 C8 */	lwz r4, gx@sda21(r13)
...
/* 800E422C 000E014C  80 8D 97 C8 */	lwz r4, gx@sda21(r13)
/* 800E4230 000E0150  98 04 04 EC */	stb r0, 0x4ec(r4)
/* 800E4234 000E0154  4B FF 91 E9 */	bl GXSaveCPUFifo
/* 800E4238 000E0158  93 CD A3 A8 */	stw r30, OldCPUFifo@sda21(r13)
...
/* 800E4288 000E01A8  80 6D 97 C8 */	lwz r3, gx@sda21(r13)
...
lbl_800E429C:
/* 800E429C 000E01BC  80 8D A3 60 */	lwz r4, __piReg@sda21(r13)
...
/* 800E42B0 000E01D0  80 6D A3 A8 */	lwz r3, OldCPUFifo@sda21(r13)
/* 800E42B4 000E01D4  4B FF 8E E1 */	bl GXSetCPUFifo
/* 800E42B8 000E01D8  80 6D 97 C8 */	lwz r3, gx@sda21(r13)
...
/* 800E42CC 000E01EC  80 8D 97 C8 */	lwz r4, gx@sda21(r13)
...
/* 800E42E8 000E0208  80 8D 97 C8 */	lwz r4, gx@sda21(r13)
...
lbl_800E42F8:
/* 800E42F8 000E0218  80 6D 97 C8 */	lwz r3, gx@sda21(r13)
...
/* 800E4354 000E0274  80 AD 97 C8 */	lwz r5, gx@sda21(r13)
...
lbl_800E4368:
/* 800E4368 000E0288  80 6D 97 C8 */	lwz r3, gx@sda21(r13)
