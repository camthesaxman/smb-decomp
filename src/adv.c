...
void submode_adv_logo_init_func(void)
{
    ...
    advLogoInfo.unk14 = modeCtrl.unk0;
    advLogoInfo.unk10 = 0;
    prevLogoPos.x = 0.0f;
    prevLogoPos.y = 0.0f;
    prevLogoPos.z = 0.0f;
...
void submode_adv_info_main_func(void)
{
    ...
    if (modeCtrl.unk0 < 3360 && modeCtrl.unk0 > 2760)
    {
        Vec sp30;
        sp30.x = 1.15f;
        sp30.y = 0.5f;
    ...
    if (!(modeCtrl.levelSetFlags & (1 << 13)) && modeCtrl.unk0 == 4320)
        func_80077DA0();
...
void submode_adv_game_play_init_func(void)
{
    ...
    infoWork.unk0 |= 0x810;
    lbl_80250A68.unk10 = func_8004964C(lbl_80250A68.unk0[lbl_80250A68.unk14]);
    animate_animgroups(func_80049F90(lbl_80250A68.unk10, lbl_80250A68.unk0[lbl_80250A68.unk14]));
