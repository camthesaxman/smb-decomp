...
void q_search_bg_models(struct BGModelSearch *a, int (*func)(int, struct GMAModelEntry *));
void q_search_bg_models_from_list(struct StageBgModel *r28, int r30_, struct BGModelSearch *a, Func800567DC b);
// ? func_80056934();
