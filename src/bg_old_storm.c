...
void bg_old_storm_init(void)
{
    ...
    backgroundInfo.unk80 = naomiBgArchive->models[7];
    ...
    sp8.unk30 = (void *)naomiBgArchive->models[1];
    spawn_effect(&sp8);
    ...
    sp8.unk30 = (void *)naomiBgArchive->models[2];
    spawn_effect(&sp8);
    ...
    sp8.unkA4 = (rand() & 0x7FF) - 0x3FF;
    sp8.unk54 -= (rand() & 0x7F) + 0x20;
    sp8.unk30 = (void *)naomiBgArchive->models[5];
    spawn_effect(&sp8);
    ...
    sp8.unkA4 = (rand() & 0x7FF) - 0x3FF;
    sp8.unk54 -= (rand() & 0x7F) + 0x20;
    sp8.unk30 = (void *)naomiBgArchive->models[6];
    spawn_effect(&sp8);
}
...
void bg_old_storm_main(void)
{
	...
	if (gameSubmode == SMD_GAME_CONTINUE_MAIN)
	{
		...
		sp24.unk30 = (void *)naomiBgArchive->models[8];
		spawn_effect(&sp24);
	}
...
void bg_old_storm_draw(void)
{
	...
	u_call_draw_naomi_model_and_do_other_stuff(naomiBgArchive->models[0]);
	u_call_draw_naomi_model_and_do_other_stuff(naomiBgArchive->models[3]);
}
