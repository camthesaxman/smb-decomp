...
void bg_old_storm_draw(void)
{
	...
	q_call_draw_naomi_model_and_do_other_stuff(naomiBackgroundObj->modelPtrs[0]);
	q_call_draw_naomi_model_and_do_other_stuff(naomiBackgroundObj->modelPtrs[3]);
}
