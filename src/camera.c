...
void camera_func_44(struct Camera *camera, struct Ball *ball)
{
    ...
    u_get_replay_info(lbl_80250A68.unk0[ball->playerId], &r30->unk8);
...
void camera_func_48(struct Camera *camera, struct Ball *ball)
{
    ...
    camera_clear(camera);
    camera->flags |= 4;
    u_get_replay_info(lbl_80250A68.unk0[ball->playerId], &sp34);
...
void camera_func_71(struct Camera *camera, struct Ball *ball)
{
    ...
    r8 = g_poolInfo.unk0.unkC;
    r9 = 0;
    for (r3 = 0; r3 < g_poolInfo.unk0.unk8; r3++, r8++)
    {
        if (*r8 == 2 || *r8 == 4)
