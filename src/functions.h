...
void func_8006B518(struct Stobj *);
void find_jamabar_and_bumper_models(void);
void spawn_bumpers(struct StageAnimGroup *, int);
void spawn_jamabars(struct StageAnimGroup *, int);
void stobj_bumper_init(struct Stobj *);
void stobj_bumper_main(struct Stobj *);
void stobj_bumper_draw(struct Stobj *);
void stobj_bumper_coli(struct Stobj *, struct PhysicsBall *);
void stobj_bumper_destroy(struct Stobj *);
void func_8006C140(struct Stobj *);
void stobj_bumper_bgspecial_init(struct Stobj *);
void stobj_bumper_bgspecial_main(struct Stobj *);
void stobj_bumper_bgspecial_draw(struct Stobj *);
void stobj_bumper_bgspecial_coli(struct Stobj *, struct PhysicsBall *);
void stobj_bumper_bgspecial_destroy(struct Stobj *);
void func_8006C408(struct Stobj *);
void stobj_jamabar_init(struct Stobj *);
void stobj_jamabar_main(struct Stobj *);
void stobj_jamabar_draw(struct Stobj *);
void stobj_jamabar_coli(struct Stobj *, struct PhysicsBall *);
void stobj_jamabar_destroy(struct Stobj *);
void func_8006C6CC(struct Stobj *);
void stobj_dummy_init(struct Stobj *);
void stobj_dummy_main(struct Stobj *);
void stobj_dummy_draw(struct Stobj *);
void stobj_dummy_coli(struct Stobj *, struct PhysicsBall *);
void stobj_dummy_destroy(struct Stobj *);
void func_8006C7B8(struct Stobj *);
void g_spawn_goal_stobjs(struct StageAnimGroup *, int);
...
void func_8006DD9C(struct Stobj *);
// ? func_8006DDA0();
...
void func_8006F3A4(struct Stobj *);
...
void func_8006F42C(struct Stobj *);
...
void func_800AFC18(struct Stobj *);
void func_800AFC1C();
void func_800AFC4C();
