...
// ? g_open_pause_menu();
// ? g_handle_pause_menu_navigation();
// ? g_pause_menu_load_how_to_play();
// ? g_activate_pause_menu_item();
// ? unkFunc8000AECC();
...
// ? g_clear_mot_transforms();
// ? g_load_mot_transforms();
// ? g_read_transform_list_from_dat();
...
void g_interp_pos_motion(struct JointBoneThing *, struct JointBoneThing *, u32, float);
void g_interp_rot_motion(struct JointBoneThing *, struct JointBoneThing *, const struct Struct80034F5C_3 *, u32, float);
float g_interp_skelanim_value_maybe(struct MotionTransform *, float);
float g_crazy_interpolation_stuff(Vec *, Vec *, float);
void read_transform_values(struct MotionTransform *, float *, float *, float *);
void g_skelanim_seek_next(struct MotionTransform *);
void g_skelanim_seek_prev(struct MotionTransform *);
...
void func_8006677C(int, int, int);
...
// ? func_80066D78();
// ? func_80066EC0();
int g_get_stage_time_limit(void);
...
// ? func_8006B2C0();
void func_8006B518(struct StageObject *);
void func_8006B594(void);
void func_8006B8E4(struct StageAnimGroup *, int);
void func_8006B9E4(struct StageAnimGroup *, int);
void func_8006BAB8(struct StageObject *);
void sot_main_bumper(struct StageObject *);
void sot_disp_bumper(struct StageObject *);
void sot_coli_bumper(struct StageObject *, struct PhysicsBall *);
void func_8006C13C(struct StageObject *);
void func_8006C140(struct StageObject *);
void func_8006C144(struct StageObject *);
void func_8006C1CC(struct StageObject *);
void func_8006C1EC(struct StageObject *);
void func_8006C3E4(struct StageObject *, struct PhysicsBall *);
void func_8006C404(struct StageObject *);
void func_8006C408(struct StageObject *);
void func_8006C40C(struct StageObject *);
void func_8006C494(struct StageObject *);
void func_8006C5F4(struct StageObject *);
void func_8006C69C(struct StageObject *, struct PhysicsBall *);
void func_8006C6C8(struct StageObject *);
void func_8006C6CC(struct StageObject *);
void func_8006C7A4(struct StageObject *);
void func_8006C7A8(struct StageObject *);
void func_8006C7AC(struct StageObject *);
void func_8006C7B0(struct StageObject *, struct PhysicsBall *);
void func_8006C7B4(struct StageObject *);
void func_8006C7B8(struct StageObject *);
void func_8006C7BC(struct StageAnimGroup *, int);
void func_8006CA1C(struct StageObject *);
void func_8006CEF4(struct StageObject *);
void func_8006D724(struct StageObject *);
void func_8006DA04(struct StageObject *, struct PhysicsBall *);
void func_8006DD98(struct StageObject *);
void func_8006DD9C(struct StageObject *);
// ? func_8006DDA0();
void sot_init_goalbag(struct StageObject *);
void sot_main_goalbag(struct StageObject *);
void sot_disp_goalbag(struct StageObject *);
void sot_coli_goalbag(struct StageObject *, struct PhysicsBall *);
void func_8006F3A0(struct StageObject *);
void func_8006F3A4(struct StageObject *);
void func_8006F3A8(struct StageObject *);
void func_8006F3C8(struct StageObject *);
void func_8006F3E8(struct StageObject *);
void func_8006F408(struct StageObject *, struct PhysicsBall *);
void func_8006F428(struct StageObject *);
void func_8006F42C(struct StageObject *);
...
void g_ape_free(struct Ape *);
// ? g_make_ape_sub();
struct Ape *g_make_ape(int);
void func_8008BA24(int);
// ? func_8008BA2C();
void g_set_ape_anim(struct Ape *, int, int, int, float);
void func_8008BEF8(int);
void g_switch_ape_character_lod_maybe(struct Ape *, int);
// ? func_8008BFB4();
...
void g_do_ape_anim(struct Ape *);
// ? g_draw_ape_transformed();
...
void g_iteratively_multiply_model_matrices(struct GMAModel *a);
...
void avdisp_set_post_multiply_color(float, float, float, float);
...
void g_set_transform_matrices(u8 *a);
...
// ? func_800AF62C();
// ? func_800AF6D4();
void func_800AF6D8(struct StageObject *);
void func_800AF73C(struct StageObject *);
void func_800AF85C(struct StageObject *);
void func_800AFA1C(struct StageObject *, struct PhysicsBall *);
void func_800AFC14(struct StageObject *);
void func_800AFC18(struct StageObject *);
void func_800AFC1C();
void func_800AFC4C();
