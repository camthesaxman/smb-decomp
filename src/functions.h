...
void stobj_bumper_init(struct Stobj_ *);
void stobj_bumper_main(struct Stobj_ *);
void stobj_bumper_draw(struct Stobj_ *);
void stobj_bumper_coli(struct Stobj_ *, struct PhysicsBall *);
void func_8006C13C(struct Stobj_ *);
void func_8006C140(struct Stobj_ *);
void stobj_bumper_bgspecial_init(struct Stobj_ *);
void stobj_bumper_bgspecial_main(struct Stobj_ *);
void stobj_bumper_bgspecial_draw(struct Stobj_ *);
void stobj_bumper_bgspecial_coli(struct Stobj_ *, struct PhysicsBall *);
void func_8006C404(struct Stobj_ *);
void func_8006C408(struct Stobj_ *);
void stobj_jamabar_init(struct Stobj_ *);
void stobj_jamabar_main(struct Stobj_ *);
void stobj_jamabar_draw(struct Stobj_ *);
void stobj_jamabar_coli(struct Stobj_ *, struct PhysicsBall *);
void func_8006C6C8(struct Stobj_ *);
void func_8006C6CC(struct Stobj_ *);
void stobj_dummy_init(struct Stobj_ *);
void stobj_dummy_main(struct Stobj_ *);
void stobj_dummy_draw(struct Stobj_ *);
void stobj_dummy_coli(struct Stobj_ *, struct PhysicsBall *);
void func_8006C7B4(struct Stobj_ *);
void func_8006C7B8(struct Stobj_ *);
void func_8006C7BC(struct StageAnimGroup *, int);
void stobj_goaltape_init(struct Stobj_ *);
void stobj_goaltape_main(struct Stobj_ *);
void stobj_goaltape_draw(struct Stobj_ *);
void stobj_goaltape_coli(struct Stobj_ *, struct PhysicsBall *);
void func_8006DD98(struct Stobj_ *);
void func_8006DD9C(struct Stobj_ *);
// ? func_8006DDA0();
void stobj_goalbag_init(struct Stobj_ *);
void stobj_goalbag_main(struct Stobj_ *);
void stobj_goalbag_draw(struct Stobj_ *);
void stobj_goalbag_coli(struct Stobj_ *, struct PhysicsBall *);
void func_8006F3A0(struct Stobj_ *);
void func_8006F3A4(struct Stobj_ *);
void stobj_goalbag_exmaster_init(struct Stobj_ *);
void stobj_goalbag_exmaster_main(struct Stobj_ *);
void stobj_goalbag_exmaster_draw(struct Stobj_ *);
void stobj_goalbag_exmaster_coli(struct Stobj_ *, struct PhysicsBall *);
void func_8006F428(struct Stobj_ *);
void func_8006F42C(struct Stobj_ *);
...
// ? func_800AF62C();
// ? func_800AF6D4();
void stobj_nameent_btn_init(struct Stobj_ *);
void stobj_nameent_btn_main(struct Stobj_ *);
void stobj_nameent_btn_draw(struct Stobj_ *);
void stobj_nameent_btn_coli(struct Stobj_ *, struct PhysicsBall *);
void func_800AFC14(struct Stobj_ *);
void func_800AFC18(struct Stobj_ *);
void func_800AFC1C();
void func_800AFC4C();
