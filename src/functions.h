...
void show_press_start_textbox(int);
void g_logo_plus_sprite_something(void);
void show_adv_copyright_text(int);
...
void g_text_box_icon(int);
void show_stage_intro_text(void);
void show_ready_text(int);
void g_init_main_normal_hud(void);
// ? func_80079D2C();
void g_init_main_competition_hud();
void show_go_text(int);
void g_show_goal_text(int);
void show_fallout_text(int);
void show_timeover_text(int);
void show_perfect_text(int);
// ? func_8007D428();
void g_show_continue_hud(void);
void show_gameover_text(int);
void show_1up_text(int);
void show_hurry_up_text(void);
void show_replay_text(int);
void func_8007E44C(int, int);
void show_nameentry_text(int);
