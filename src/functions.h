...
void func_800AE930(int);
void func_800AEAD0(void);
int is_censored_name(char *);
void func_800AEBA8(void);
struct Struct802C6220_sub *func_800AEC74(int, struct Struct802C6220_sub *);
int func_800AECCC(int, void *);
void func_800AED54(char *);
...
void func_800AF3B0(struct Effect *, int);
