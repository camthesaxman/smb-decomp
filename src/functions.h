...
// ? q_open_pause_menu();
// ? q_handle_pause_menu_navigation();
// ? q_pause_menu_load_how_to_play();
// ? q_activate_pause_menu_item();
// ? unkFunc8000AECC();
...
void q_store_gamedata();
void q_load_gamedata();
...
void q_debug_set_cursor_pos(int, int);
// ? func_8002FC90();
// ? func_8002FCAC();
void func_8002FCC0(int, char *, ...);
void q_debug_set_text_color(int);
// ? func_8002FD68();
void func_8002FFEC(void);
// ? func_80030030();
void q_debug_printf(const char *, ...);
void q_debug_print();
...
// ? q_clear_mot_transforms();
// ? q_load_mot_transforms();
// ? q_read_transform_list_from_dat();
...
void q_interp_pos_motion(struct JointBoneThing *, struct JointBoneThing *, u32, float);
void q_interp_rot_motion(struct JointBoneThing *, struct JointBoneThing *, const struct Struct80034F5C_3 *, u32, float);
float q_interp_skelanim_value_maybe(struct MotionTransform *, float);
float q_crazy_interpolation_stuff(Vec *, Vec *, float);
void read_transform_values(struct MotionTransform *, float *, float *, float *);
void q_skelanim_seek_next(struct MotionTransform *);
void q_skelanim_seek_prev(struct MotionTransform *);
...
void q_apply_func_to_naomi_model_vertices(struct NaomiModel *model, void (*b)(struct NaomiVtxWithNormal *), void (*c)(struct NaomiVtxWithColor *));
void q_apply_func_to_naomi_dl_pos_nrm_tex(struct NaomiDispList *dl, void *end, void (*func)(struct NaomiVtxWithNormal *));
void q_apply_func_to_naomi_dl_pos_color_tex(struct NaomiDispList *dl, void *end, void (*func)(struct NaomiVtxWithColor *));
// ? func_80048084();
void func_80048420();
...
void q_get_replay_info(int, struct ReplayInfo *);
...
// ? func_80066D78();
// ? func_80066EC0();
int q_get_stage_time_limit(void);
...
// ? func_8006F428();
// ? func_8006F42C();
void q_break_goal_tape(int, struct PhysicsBall *);
...
int q_get_monkey_bitmap_id(int, int, int);
// ? func_80081D34();
// ? func_80081D64();
// ? func_80081D90();
// ? func_80081DBC();
...
// ? func_8008A7F0();
// ? q_free_character_graphics();
// ? q_load_character_graphics();
//struct GMAShape *next_shape(struct GMAShape *);
void mot_ape_init(void);
void func_8008B0AC(void);
void q_ape_free(struct Ape *);
// ? q_make_ape_sub();
struct Ape *q_make_ape(int);
void func_8008BA24(int);
// ? func_8008BA2C();
void q_set_ape_anim(struct Ape *, int, int, int, float);
void func_8008BEF8(int);
void q_switch_ape_character_lod_maybe(struct Ape *, int);
// ? func_8008BFB4();
...
void q_do_ape_anim(struct Ape *);
// ? q_draw_ape_transformed();
...
BallEnvFunc q_avdisp_set_some_func_1(BallEnvFunc a);
// ? q_avdisp_set_some_func_2();
// ? func_8008E5F8();
// ? func_8008E64C();
...
void q_set_transform_matrices(u8 *a);
...
void q_init_shadow_stuff_probably(struct Struct80092B98 *);
int func_80092D34(void);
void q_draw_ball_shadow(void);
...
void q_something_with_lens_flare_2();
void q_something_with_lens_flare_1();
// ? func_800946BC();
