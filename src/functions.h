...
// ? func_80075B5C();
void g_set_textbox_text(int, void *);
// ? func_80075CD4();
...
void func_8007884C(void);
void func_800790BC(int);
void g_init_main_normal_hud(void);
// ? func_80079D2C();
void g_init_main_competition_hud();
void func_8007C104(int);
void func_8007C6AC(int);
void func_8007CE50(int);
void func_8007D190(int);
void func_8007D3A4(int);
// ? func_8007D428();
void func_8007D580(void);
void func_8007DCD8(int);
void func_8007DEC8(int);
void func_8007E144(void);
void func_8007E334(int);
void func_8007E44C(int, int);
void func_8007EA2C(int);
...
// ? func_8008B0AC();
void func_8008B2D4(struct Ape *);
// ? func_8008B3B8();
struct Ape *g_make_ape(int);
void func_8008BA24(int);
// ? func_8008BA2C();
void func_8008BBD4(struct Ape *, int, int, int, float);
void func_8008BEF8(int);
void func_8008BF00(struct Ape *, int);
// ? func_8008BFB4();
void func_8008BFDC(struct Ape *, int, int);
void func_8008C090(struct Ape *, Vec *);
void func_8008C408(struct Ape *, Vec *);
void func_8008C4A0(float);
void func_8008C4A8(struct Ape *);
// ? func_8008C674();
// ? func_8008C924();
// ? func_8008CAAC();
// ? func_8008CBD0();
...
void avdisp_set_alpha(float);
// ? avdisp_set_light_mask();
void g_avdisp_set_and_normalize_some_vec(Vec *a);
void g_avdisp_set_some_color_scale(float, float, float);
...
struct GMAShape *draw_model_8008F914(struct GMAModel *model, struct GMAShape *mesh, struct GMATevLayer *c);
// ? func_8008FBB0();
// ? draw_shape_reflection_maybe();
void draw_indexed_model(struct GMAModel *model, struct GMAShape *b, struct GMATevLayer *mtrl);
void func_8008FE44(struct GMAModel *model, struct GMAShape *b);
// ? g_compute_texmtx0();
// ? g_compute_texmtx1and2();
void init_some_texture(void);
void build_tev_material(struct GMAShape *a, struct GMATevLayer *b);
void post_multiply_tev_stage_build(GXTevStageID a);
void post_add_tev_stage_build(GXTevStageID a);
void diffuse_layer_build_uncached(struct TevStageInfo *a, GXTevColorArg colorArg, GXTevAlphaArg alphaArg, GXTexGenSrc texGenSrc);
void diffuse_layer_build_cached(struct TevStageInfo *a, GXTevColorArg colorArg, GXTevAlphaArg alphaArg);
void diffuse_layer_next(struct TevStageInfo *a);
void alpha_blend_layer_build_uncached(struct TevStageInfo *a, GXTevColorArg colorArg, GXTevAlphaArg alphaArg, GXTexGenSrc texGenSrc);
void alpha_blend_layer_build_cached(struct TevStageInfo *a, GXTevColorArg colorArg, GXTevAlphaArg alphaArg);
void alpha_blend_layer_next(struct TevStageInfo *a);
void view_specular_layer_build_uncached(struct TevStageInfo *a, GXTevColorArg colorArg, GXTevAlphaArg alphaArg, u32 d);
void view_specular_layer_build_cached(struct TevStageInfo *a, GXTevColorArg colorArg, GXTevAlphaArg alphaArg);
void view_specular_layer_next(struct TevStageInfo *a);
void world_specular_layer_build_uncached(struct TevStageInfo *a, GXTevColorArg colorArg, GXTevAlphaArg alphaArg, u32 d);
void world_specular_layer_build_cached(struct TevStageInfo *a, GXTevColorArg colorArg, GXTevAlphaArg alphaArg);
void world_specular_layer_next(struct TevStageInfo *a);
void unk3_layer_build_uncached(struct TevStageInfo *a, GXTevColorArg colorArg, GXTevAlphaArg alphaArg, GXTexGenSrc texGenSrc);
void unk3_layer_build_cached(struct TevStageInfo *a, GXTevColorArg colorArg, GXTevAlphaArg alphaArg);
