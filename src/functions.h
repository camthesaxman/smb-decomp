...
// ? func_80021958();
// ? func_80021C44();
void g_init_light_stuff_for_stage();
void func_80021ECC();
BOOL alloc_light(struct Light *a);
void load_light_group(int);
...
void func_800225C0();
// ? func_800225F4();
void g_set_bg_ambient(float, float, float);
void g_set_ambient_color(float r, float g, float b);
// ? get_curr_light_group_ambient_color();
// ? apply_curr_light_group_ambient_color();
