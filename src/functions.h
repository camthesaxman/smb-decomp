...
void g_avdisp_maybe_draw_model_1(struct GMAModel *);
void g_avdisp_maybe_draw_model_2(struct GMAModel *);
...
void g_avdisp_draw_model_1(struct GMAModel *a);
// ? skip_mesh();
void g_avdisp_draw_model_2(struct GMAModel *a);
void g_avdisp_draw_model_3(struct GMAModel *a);
...
struct GMAShape *draw_model_8008F914(struct GMAModel *model, struct GMAShape *mesh, struct GMATevStageDesc *c);
// ? func_8008FBB0();
...
void g_build_tev_material(struct GMAShape *a, struct GMATevStageDesc *b);
void build_tev_post_multiply_stage(GXTevStageID a);
void build_tev_post_add_stage(GXTevStageID a);
