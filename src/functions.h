...
float mathutil_sqrt(double);
float mathutil_rsqrt(double);
float mathutil_sin(register u32 angle);
...
void mathutil_mtxA_from_quat(Quaternion *q);
void mathutil_quat_mult(Quaternion *a, Quaternion *b, Quaternion *c);
