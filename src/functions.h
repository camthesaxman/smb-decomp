...
void func_8002DB10(struct MemcardGameData*);
void func_8002DB24(struct MemcardGameData*);
void func_8002DB38();
...
void u_something_with_lens_flare_2(int);
void u_something_with_lens_flare_1(int);
...
int u_read_dvd_file(struct DVDFileInfo *file, void *arg1, u32 arg2, int arg3);
