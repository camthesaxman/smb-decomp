...
void bg_old_sand_draw(void)
{
    ...
    memcpy(lbl_802F1B4C, NLOBJ_MODEL(naomiBgArchive, 1), NLMODEL_HEADER(NLOBJ_MODEL(naomiBgArchive, 1))->unk4->modelSize);
    ...
    memcpy(lbl_802F1B4C, NLOBJ_MODEL(naomiBgArchive, 3), NLMODEL_HEADER(NLOBJ_MODEL(naomiBgArchive, 3))->unk4->modelSize);
    ...
    u_call_draw_naomi_model_and_do_other_stuff(NLOBJ_MODEL(naomiBgArchive, 4));
}
