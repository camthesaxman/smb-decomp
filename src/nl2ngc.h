...
void q_call_draw_naomi_model_1(struct NaomiModel *a);
...
void q_draw_naomi_model_3(struct NaomiModel *);
void q_draw_naomi_model_4(struct NaomiModel *);
void q_draw_naomi_model_5(struct NaomiModel *);
void q_draw_naomi_model_with_mesh_func(struct NaomiModel *a, int (*func)());
