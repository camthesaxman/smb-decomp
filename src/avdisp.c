...
void func_80090524(struct GMAShape *a, struct UnkStruct31 *b)
{
    ...
    else
    {
        ...
        // r24 = &lbl_802B4ECC.unk54Keyframes doesn't change
        // r14 = &sp2C doesn't change
        // r25 = &lbl_802B4ECC.unk50KeyframeCount  doesn't change
        ...
        while (r20 > 0)
        {
            ...
            else if (r16 & 1)
            {
                if (lbl_802B4ECC.unk50 == 0)
                {
                    ...
                    //lbl_80090BEC
                    func_8009F33C(0, sp28);
                    lbl_802B4ECC.unk50KeyframeCount = 1;
                    */
